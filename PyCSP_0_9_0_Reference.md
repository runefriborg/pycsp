...
|  MultiProcess(func, host, port, *args, **kwargs)<br>
|<br>
...
|    >>>   pass # perform filtering<br>
|    >>><br>
|    >>> P = MultiProcess(filter, "localhost", 0, A.reader(), B.writer(), "42", debug=True)<br>
|<br>
|  MultiProcess(func, host, port, *args, **kwargs)<br>
|  func<br>
|    The function object to wrap and execute in the body of the process.<br>
...
<br>
AltSelect performs a choice from a list of guard objects and<br>
