...
# -*- coding: utf-8 -*-
# 
# migtest - a part of the MiG scripts
...
if len(sys.argv) - 1 == 0:
    op_list = ['cancel', 'cat', 'doc', 'get', 'head', 'jobaction', 'liveio', 'ls', 'mkdir', 'mqueue', 'mv', 'put', 'read', 'rm', 'rmdir', 'stat', 'status', 'submit', 'resubmit', 'tail', 'touch', 'truncate', 'unzip', 'wc', 'write', 'zip']
else:   
    op_list = sys.argv[1:]
